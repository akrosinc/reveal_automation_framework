...
/**
 * @author Yonela Ntlokwana added on 20th October 2022
 *
 */
public  class Action extends BaseClass implements ActionInterface {
     ...
     *
     * @param element name : Meaningful name to the element (Ex:Year Dropdown, items
     *                    Listbox etc..)
     */
    ...
    public String screenShot(WebDriver driver, String filename) {
        ...
        String newImageString = "http://localhost:8082/job/reveal_automation_framework/ws/reveal_automation_framework/ScreenShots/" + filename + "_"
                + dateName + ".png";
